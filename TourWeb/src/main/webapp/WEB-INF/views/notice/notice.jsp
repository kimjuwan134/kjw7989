	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			...
			<div class="pagination">
				<a href="${pageContext.request.contextPath}/board/list?pageNum=1&search=${pageDTO.search}" class="firstpage  pbtn"><img src="${pageContext.request.contextPath}/resources/img/btn_firstpage.png" alt="처음"></a>
				<c:if test="${pageDTO.currentPage > 1}">
<!-- 				처음 페이지 아닌 경우 이전 버튼 보이기 -->
					<a href="${pageContext.request.contextPath}/board/list?pageNum=${pageDTO.currentPage - 1}&search=${pageDTO.search}" class="prevpage  pbtn"><img src="${pageContext.request.contextPath}/resources/img/btn_prevpage.png" alt="이전"></a>
				</c:if>
...
<!-- 				마지막 페이지 아닌 경우 다음 페이지 보이기 -->
					<a href="${pageContext.request.contextPath}/board/list?pageNum=${pageDTO.currentPage + 1}&search=${pageDTO.search}" class="nextpage  pbtn"><img src="${pageContext.request.contextPath}/resources/img/btn_nextpage.png" alt="다음"></a>
				</c:if>
				<a href="${pageContext.request.contextPath}/board/list?pageNum=${pageDTO.pageCount}&search=${pageDTO.search}" class="lastpage  pbtn"><img src="${pageContext.request.contextPath}/resources/img/btn_lastpage.png" alt="마지막"></a>
			</div>
			<!-- //pagination -->
		</div>
		<!-- //bodytext_area -->
