								...
								<li class="clear">
									...
									<div class="reg_content radio_area">
									  <c:if test="${memberDTO.agree eq 'agree'}">
										...
										<input type="radio" class="css-radio" id="smsno_lbl" name="agree" value="disagree"><label for="smsno_lbl">동의 안함</label>
									  </c:if>
									  <c:if test="${memberDTO.agree eq 'disagree'}">	
										...
										<input type="radio" class="css-radio" id="smsno_lbl" name="agree" value="disagree" checked><label for="smsno_lbl">동의 안함</label>
									  </c:if>	
